...
namespace Silk.Data.Migrations
{
    public partial class ConfigMerge : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE invite_configs ic SET \"GuildModConfigId\" = (SELECT gc.\"Id\" FROM guild_configs gc INNER JOIN temp t USING (guild_id) WHERE t.\"Id\" = ic.\"GuildConfigEId\" );");
