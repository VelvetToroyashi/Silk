...
namespace Silk.Data.Migrations
{
    ...
    [Migration("20210711083314_RemovedGreetMembersFromGuildConfig")]
    partial class RemovedGreetMembersFromGuildConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Silk.Data.Models.RoleMenuEmoji", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("Silk.Data.Models.RoleMenuMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Silk.Data.Models.RoleMenuOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Silk.Data.Models.UserHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Silk.Data.Models.RoleMenuOption", b =>
                {
                    b.HasOne("Silk.Data.Models.RoleMenuEmoji", "Emoji")
                        .WithMany()
                        .HasForeignKey("EmojiId");

                    b.HasOne("Silk.Data.Models.RoleMenuMenu", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("Silk.Data.Models.UserHistory", b =>
                {
                    b.HasOne("Silk.Data.Models.User", "User")
                        .WithOne("History")
                        .HasForeignKey("Silk.Data.Models.UserHistory", "UserId", "GuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
