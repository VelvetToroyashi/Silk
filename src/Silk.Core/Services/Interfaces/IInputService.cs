...
namespace Silk.Core.Services.Interfaces
{
    public interface IInputService
    {
        ...
        ///     <para>
        ///         Differs from <see cref="GetStringInputAsync" /> in that it returns a <see cref="IMessage" /> or <see langword="null" /> if it does not
        ///         exist
        ///     </para>
        /// </summary>
        /// <param name="userId">The Id of the user to listen for input from.</param>
        ...
        public Task<DiscordMessage?> GetInputAsync(ulong userId, ulong channelId, ulong? guildId = null, TimeSpan? timeOut = null);
